...
class RayTracingCommand : public PipelineCommand {
 public:
  ...
  void SetRayGenSBTName(std::string& name) { rgen_SBT_name_ = name; }
  std::string GetRayGenSBTName() const { return rgen_SBT_name_; }

  void SetMissSBTName(std::string& name) { miss_SBT_name_ = name; }
  std::string GetMissSBTName() const { return miss_SBT_name_; }

  void SetHitsSBTName(std::string& name) { hits_SBT_name_ = name; }
  std::string GetHitsSBTName() const { return hits_SBT_name_; }

  void SetCallSBTName(std::string& name) { call_SBT_name_ = name; }
