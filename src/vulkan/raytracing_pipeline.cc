...
VkDeviceAddress getBufferDeviceAddress(Device* device, VkBuffer buffer) {
...
Result RayTracingPipeline::CreateVkRayTracingPipeline(
  ...
  VkRayTracingPipelineCreateInfoKHR pipeline_info = VkRayTracingPipelineCreateInfoKHR();
  const uint32_t maxRecursionDepth = 1u; // TODO
  ...
  VkRayTracingPipelineCreateInfoKHR pipelineCreateInfo
  {
    ...
    (uint32_t)shader_stage_info.size(),                     //  uint32_t                                    stageCount;
    shader_stage_info.data(),                               //  const VkPipelineShaderStageCreateInfo*      pStages;
    (uint32_t)shader_group_create_info_.size(),             //  uint32_t                                    groupCount;
    shader_group_create_info_.data(),                       //  const VkRayTracingShaderGroupCreateInfoKHR* pGroups;
    maxRecursionDepth,                                      //  uint32_t                                    maxRecursionDepth;
    nullptr,                                                //  VkPipelineLibraryCreateInfoKHR*             pLibraryInfo;
    nullptr,                                                //  VkRayTracingPipelineInterfaceCreateInfoKHR* pLibraryInterface;
    nullptr,                                                //  const VkPipelineDynamicStateCreateInfo*     pDynamicState;
    pipeline_layout,                                        //  VkPipelineLayout                            layout;
    (VkPipeline)nullptr,                                    //  VkPipeline                                  basePipelineHandle;
    0,                                                      //  int32_t                                     basePipelineIndex;
  };

  VkResult r = device_->GetPtrs()->vkCreateRayTracingPipelinesKHR(
      device_->GetVkDevice(), nullptr, nullptr, 1u, &pipelineCreateInfo,
      nullptr, pipeline);
  if (r != VK_SUCCESS)
...
Result RayTracingPipeline::TraceRays(amber::SBT* rSBT,
...

  {
    ...
    device_->GetPtrs()->vkCmdBindPipeline(command_->GetVkCommandBuffer(), VK_PIPELINE_BIND_POINT_RAY_TRACING_KHR,
                                          pipeline);
